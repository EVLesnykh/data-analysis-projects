# Проект: Проектирование и разработка базы данных работы блочной теплоэлектроцентрали (ТЭЦ) в MySQL Workbench.
...
Презентация к проекту:<br>
[Презентация](https://github.com/EVLesnykh/data-analysis-projects/blob/main/block-thermal-power-plant-db/Presentation_Lesnykh_EV.pptx)
